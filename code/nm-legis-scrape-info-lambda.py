# for copy / past into Lambda function for each office
# office variables already defined

    office_url = f'https://nmlegis.gov/Members/Legislator_List?T={office_identifier}'
    r_office = requests.get(office_url)
    office_soup = BeautifulSoup(r_office.content)
        ...
        for row in info.findAll('li', attrs = {'class':'list-group-item'}):
            ...
            try: 
                ...
                try: 
                    ...
                    info_soup = BeautifulSoup(info_row)
